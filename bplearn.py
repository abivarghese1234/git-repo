...
imgFull = cv2.imread("C:/New Folder/PCB inspection/Inspecting  SMD/123clahe.jpg",0)
template = cv2.imread("C:/New Folder/PCB inspection/Inspecting  SMD/template12.jpg",0)
GoldenImg = cv2.imread("C:/New Folder/PCB inspection/Inspecting  SMD/123.jpg")
template1 = cv2.imread("C:/New Folder/PCB inspection/Inspecting  SMD/template2NewCol.jpg",0)
